...
public class RequestHandler {
	...
	
	{
		...
		delegateMap.put("author", new AuthorDelegate());
		delegateMap.put("user", new LoginDelegate());
		delegateMap.put("editor", new EditorDelegate());
